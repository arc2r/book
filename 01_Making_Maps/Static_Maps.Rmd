...
As we saw in chapter \@ref(data), we can quickly visualize geodata by simply calling `plot` on the dataset. 
...
//body ArcGIS Users are usually not familiar with ESPG Codes, we should provide an introduction somewhere and reference this here.
...
//body add an example of how sf and raster can be layered. This needs an additional dataset.
