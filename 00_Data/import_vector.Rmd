...
To handle these simple features / vector data in `R`, we need the library `sf`.First, let's load the library `sf`. Read chapter PLACEHOLDER If you haven't installed it yet.
