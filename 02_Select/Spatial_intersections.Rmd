...
One of the most commonly used operations in ArcGIS pro is the one called _Buffer_. This operation provides a very convenient way of identifying areas of interest lying in the neighborhood of an existing spatial feature. In R the same action can be performed using the _st_buffer_ function in _sf_. 
...
=======
So, ultimately, as we can see above, the _st_intersection_ function creates a result where the point dataset is precisely "clipped" based on the area of interest. 
>>>>>>> 8d12a0f18210eaf813d444e49e16a4ebe2aa0ee7
