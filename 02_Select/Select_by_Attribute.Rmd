...
ggplot() + geom_sf(data = parkBikes) + geom_sf(data = parkBikes_winti, aes(color = "Bike parking facilities in Winterthur")) + theme(legend.title=element_blank()) + ggtitle("Bike parking facilities in Canton Zurich")
```
