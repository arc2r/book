...
ggplot() + geom_sf(data = gemeinde_zh) + geom_sf(data = richterswil,aes(fill = Municipality))
+ geom_sf(data = badeplaetze_zh,color = "blue") + ggtitle("Swimming spots in the Canton of Zurich") + theme_minimal() + coord_sf(datum = 2056)
```
