...
`R`, you will find only the most commonly used 9 named spatial relations. These are known as ["Spatial predicates"](https://en.wikipedia.org/wiki/DE-9IM#Spatial_predicates). 
...
<!--
# todo(KimboGilda): Write an example for this chapter, reusing the same dataset if possible
