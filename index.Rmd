...
- The fundamental building block of ArcGIS is a visual representation of your data (i.e. the map). The fundamental building block in `R` is your RScript. The visual aspect makes ArcGIS more approachable, but also less scaleable.
...
- ArcGIS follows the concept of creating a tool for *every* situation you might encounter. With this approach, they provide a selection of > 1'000 geoprocessing tools to your disposal. Generally speaking, the authors of Packages will try to keep the number of functions as small as possible, since this reduces maintenance. See [this github thread](https://github.com/r-spatial/sf/issues/609) and [this comment](https://github.com/r-spatial/sf/issues/702#issuecomment-381488716) <!-- https://github.com/r-spatial/sf/pull/536#issuecomment-341685846 -->
