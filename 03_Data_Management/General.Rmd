...
gemeinde_asc <- gemeinde[order(-gemeinde$Area),] # sort the dataset based on the Area in ascending order

gemeinde_desc <- gemeinde[order(-gemeinde$Area),] # sort the dataset based on the Area in descending order
