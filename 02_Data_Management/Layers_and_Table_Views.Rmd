...
//todo does this stay here or move to Analysis -> Extract -> Select? --> It stays here under the umbrella of Layers and Table Views toolset (https://pro.arcgis.com/en/pro-app/latest/tool-reference/data-management/select-layer-by-attribute.htm) == Geoprocessing Tools/Data Management toolbox/Layers and Table Views toolset 
...
<<<<<<< HEAD:02_Select/Select_by_Location.Rmd
richterswil <- filter(gemeinde_zh, gemeindena == "Richterswil")
names(richterswil)[5] = "Municipality"

ggplot() + 
  geom_sf(data = gemeinde_zh) + 
  geom_sf(data = richterswil, aes(fill = Municipality)) +
...
=======
>>>>>>> 7fdb8e7f67b09eef9ff3661eceb4fe78626b7a1a:02_Data_Management/Layers_and_Table_Views.Rmd
