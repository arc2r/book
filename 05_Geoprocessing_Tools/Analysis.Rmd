...
The case closest / closest geodesic is a special case, for which ArcGIS provides an extrememly fast and easy solution, that R (currently) can't keep up with. The question "which object is closest to this object" theoretically requires you to measure the distances of _all_ objects to determin the closest one. SThis problem is known as the K-Nearest-Neighbour problem (KNN) and currently does not have nice implemenation in sf. 
